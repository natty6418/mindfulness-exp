...
ppg_signal = np.loadtxt("./data/test/participant_test_ppg_data.csv", delimiter=",", skiprows=1, usecols=1)
time = np.loadtxt("./data/test/participant_test_ppg_data.csv", delimiter=",", skiprows=1, usecols=0)
