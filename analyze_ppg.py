...
ppg_signal = np.loadtxt("./data/participant_unknown_ppg_data.txt", delimiter=",", skiprows=1, usecols=1)
time = np.loadtxt("./data/participant_unknown_ppg_data.txt", delimiter=",", skiprows=1, usecols=0)
